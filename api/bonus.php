...
if ($method === 'POST') {
    ...
    $stmt = $db->prepare('INSERT INTO bonus_records (id, employeeId, empCode, empName, shopId, year, bonusAmount, bonusStatus, summary, attendanceSummary) VALUES (?,?,?,?,?,?,0,"pending",NULL,?)');
